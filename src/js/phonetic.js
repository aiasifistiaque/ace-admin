...
const transcribe = str => {
  let car = str;

  //? car = car.replace(/্-/g, "‍্");
  for (let i = 0; i < 1; i++) {
    car = car.replace(/o/g, 'অ');
    ...
    //car = car.replace(/[Oo]/g, 'ও');
    car = car.replace(/অঅ/g, 'ও');
    car = car.replace(/অই/g, 'ঐ');
    car = car.replace(/অউ/g, 'ঔ');
    //car = car.replace(/অo/g, 'ও');

    //cons
    car = car.replace(/n/g, 'ন্');
    car = car.replace(/k/g, 'ক্');
    car = car.replace(/q/g, 'ক্');
    car = car.replace(/g/g, 'গ্');
    car = car.replace(/ch/g, 'চ্');
    car = car.replace(/চ্h/g, 'ছ্');
    ...
    car = car.replace(/[çśŚ]/g, 'শ্');

    //benjon borno
    car = car.replace(/q/g, 'ক্ক');
